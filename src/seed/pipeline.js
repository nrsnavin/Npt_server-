  ...
  const enquiryRows = [
    {
      ...
      assignedTo: nandhini._id,
      mould: byCode['M-102'],
      requirement: { modelNumber: 'NPT-400S', category: 'shirt', sizeMm: 400, material: 'plastic', colour: 'White', printing: 'SCM logo, single colour', packing: '200 pcs per carton' },
      targetPrice: 4.9,
    ...
    },
    {
      ...
      assignedTo: nandhini._id,
      mould: byCode['M-118'],
      requirement: { modelNumber: 'NPT-420T', category: 'trouser', sizeMm: 420, material: 'plastic', colour: 'Black', packing: '100 pcs per carton' },
      targetPrice: 8.4,
      requiredDeliveryDate: days(24),
    ...
    },
    {
       ...
       */
      mould: byCode['M-102'],
      requirement: { modelNumber: 'NPT-400R', category: 'shirt', sizeMm: 400, material: 'recycled_pp', colour: 'Charcoal', printing: 'GRS mark on the shoulder', packing: '200 pcs per carton' },
      targetPrice: 5.6,
    ...
    },
    {
      ...
      requirement: { modelNumber: 'Matte 400mm white — new finish', category: 'shirt', sizeMm: 400, material: 'plastic', colour: 'Matte White', packing: '200 pcs per carton' },
    ...
    },
    {
      ...
      assignedTo: arun._id,
      mould: byCode['M-141'],
      requirement: { modelNumber: 'NPT-410V', category: 'suit', sizeMm: 410, material: 'velvet', colour: 'Charcoal', packing: '50 pcs per carton' },
      targetPrice: 20,
    ...
    },
    {
      ...
      assignedTo: arun._id,
      mould: byCode['M-124'],
      requirement: { modelNumber: 'NPT-450C', category: 'coat', sizeMm: 450, material: 'plastic', colour: 'Black', packing: '50 pcs per carton, export cartons' },
      targetPrice: 11.8,
    ...
    },
    {
      ...
      assignedTo: nandhini._id,
      mould: byCode['M-107'],
      requirement: { modelNumber: 'NPT-300K', category: 'kids', sizeMm: 300, material: 'plastic', colour: 'Assorted', packing: '250 pcs per carton' },
      status: 'won',
    ...
    },
    {
      ...
      assignedTo: nandhini._id,
      mould: byCode['M-101'],
      requirement: { modelNumber: 'NPT-380S', category: 'shirt', sizeMm: 380, material: 'plastic', colour: 'White', packing: '200 pcs per carton' },
      status: 'lost',
      lostReason: 'price',
    ...
    },
    {
       ...
       */
      requirement: { modelNumber: 'NPT-360W', category: 'skirt', sizeMm: 360, material: 'wood', colour: 'Natural', packing: '25 pcs per carton' },
      status: 'hold',
